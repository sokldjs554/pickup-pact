...
- `ui-e2e`: local Chromium verification of the virtual-customer browse/cart/order/pickup-pact/renegotiation/automatic-compensation/pickup-code/receipt/history/cancel journey, the full expert operator flow, capacity/conflict labs, and a narrow mobile viewport.
